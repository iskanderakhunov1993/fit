...
const phaseNotes: Record<CyclePhase, Record<string, string>> = {
  menstruation: {
    light: "Менструальная фаза — время восстановления. Мягкие движения помогут при спазмах.",
  ...
  follicular: {
    ...
    moderate: "Отличное время для прогресса. Мышцы восстанавливаются быстрее.",
    intense: "Пик восстановления мышц. Лучшее время для силовых и новых рекордов.",
  },
  ovulation: {
    light: "Овуляция — пик энергии. Лёгкая тренировка по твоему запросу.",
    moderate: "Можешь больше — тело сейчас на максимуме.",
    intense: "Максимум силы и выносливости. Пользуйся моментом!",
  },
  luteal: {
