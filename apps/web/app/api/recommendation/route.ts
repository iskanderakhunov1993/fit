    ...
    messages: [
      {
        role: "system",
        content:
          "Ты Ayla, мягкий премиальный AI wellness-коуч для женщин. Никогда не ставь диагнозы. Используй вероятностные формулировки. Отвечай кратко, поддерживающе и на русском языке."
      },
      {
        role: "user",
